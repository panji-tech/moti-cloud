...
public class FtpUtil {
     ...
     * FTP服务器基础目录
     */
    private static String BASEPATH = "/wangpan";
    /**
     * FTP客户端
     */
    ...
    public static boolean initFtpClient() {
        ...
        try {
            ...
            log.info("FTP 服务器连接成功！");
        } catch (Exception e) {
            log.info("FTP 服务器连接异常：{}", e.getCause(), e);
            throw new RuntimeException("FTP 服务连接异常:" + e.getCause());
        }
        return true;
    }

    private static FTPClient createFtp() throws IOException {
        ...
        newFtp.setBufferSize(10240);
        //设置传输超时时间为60秒
        newFtp.setDataTimeout(600000);
        //连接超时为60秒
        newFtp.setConnectTimeout(600000);
        //FTP以二进制形式传输
        newFtp.setFileType(FTP.BINARY_FILE_TYPE);
        return newFtp;
    }
